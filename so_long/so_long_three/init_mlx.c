...
/*   Updated: 2022/11/25 07:17:05 by sounchoi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_mlx(t_mlx *mlx, t_gm_obj *obj, t_err_m err_m)
{
	...
	mlx->win_ptr = mlx_new_window(mlx->mlx_ptr, (obj->x_max) * TILE_SIZE, \
	(obj->y_max + 1) * TILE_SIZE, "so_long");
	if (mlx->win_ptr == NULL)
