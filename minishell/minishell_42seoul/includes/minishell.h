...
/*   Updated: 2023/02/05 03:09:15 by junsyun          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			check_rdhd_syntax(char **args);
void		syntax_error_rdhd(int check);
int			ft_strchars_i(const char *s, char *set);
/* remove */
int			check_here(char **args, int *i);
int			check_redi(char **args, int *i);
...
int			get_here_doc(char *str[2], char *buf[2]);
...
void		delete_str_unset(t_envp_list **envp, \
						t_envp_list *memo, t_envp_list *before_memo);
// new_exit.c
